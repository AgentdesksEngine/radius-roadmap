        ...
        <Command.Group heading="Actions">
          {[
            ...
            },
            {
              ...
              fn: () => setTheme(resolved === 'dark' ? 'light' : 'dark'),
            },
            {
              id: 'refresh',
              label: 'Refresh data',
              icon: <RefreshCw />,
              fn: () => qc.invalidateQueries(),
            },
            {
              id: 'github',
              label: 'Open project in GitHub',
              icon: <ExternalLink />,
              fn: () => window.open(schema?.url, '_blank'),
            },
            {
              id: 'signout',
              label: 'Sign out',
              icon: <LogOut />,
              fn: () => (window.location.href = '/api/auth/logout'),
            },
          ]
